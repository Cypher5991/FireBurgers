    ...
    <div className="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-3">
        ...
        <h1 className="text-3xl sm:text-5xl font-black font-syne tracking-tight text-brand-dark">
          Sector 8-B Flagship & Curbside Hop
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white p-7 sm:p-8 rounded-3xl editorial-border shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-sans">
              <div className="p-4 rounded-2xl bg-zinc-50 editorial-border-light space-y-1.5">
              ...
              <div className="p-4 rounded-2xl bg-zinc-50 editorial-border-light space-y-1.5">
                <div className="flex items-center gap-2 text-brand-glaze font-mono font-bold">
            ...
            <div className="p-5 rounded-2xl bg-brand-dark text-brand-canvas flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-5 py-2.5 rounded-xl bg-brand-ember text-white font-syne font-bold text-xs hover:brightness-110 transition shrink-0 flex items-center gap-1.5 shadow-md"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl bg-white editorial-border-light shadow-sm space-y-2">
              <div className="flex items-center gap-1 text-brand-glaze text-xs">
                {'★'.repeat(5)}
              </div>
        ...
        <div className="lg:col-span-5 sticky top-24 space-y-4">
          <div className="deep-slate-panel p-6 sm:p-8 rounded-3xl shadow-2xl space-y-5">
            
            <div className="flex items-center justify-between border-b border-white/10 pb-3">
              <div className="flex items-center gap-2">
                <Car className="w-5 h-5 text-brand-glaze" />
                <h3 className="font-syne font-black text-xl text-white">
                  Curbside Car-Hop
                </h3>
              </div>
              <span className="w-2.5 h-2.5 rounded-full bg-brand-glaze animate-ping" />
            </div>
            ...
            {registered ? (
              <div className="p-5 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 space-y-2 animate-fade-in text-center">
