    ...
    <section id="sensory-reveal" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-8 flex flex-col items-center">
          ...
          >
            ...
            <div className="absolute inset-0 w-full h-full bg-[#141416] flex items-center justify-center">
              ...
              />
              <div className="absolute bottom-6 left-6 bg-[#141416]/90 backdrop-blur-md px-4 py-2 rounded-xl border border-brand-ember/30 shadow-lg">
            ...
            >
              ...
              />
              <div className="absolute bottom-6 right-6 bg-[#141416]/90 backdrop-blur-md px-4 py-2 rounded-xl border border-brand-ember/30 shadow-lg">
                <p className="text-[11px] uppercase tracking-wider text-white font-mono font-bold bg-brand-ember px-2 py-0.5 rounded">
            ...
            >
              <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-11 h-11 bg-brand-dark border-2 border-brand-ember rounded-full flex items-center justify-center shadow-2xl">
            ...
            {/* Bottom Instructions */}
            <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-brand-dark/90 text-white backdrop-blur-md px-4 py-1 rounded-full text-[11px] font-mono font-bold pointer-events-none flex items-center gap-2 border border-brand-ember/30">
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="deep-slate-panel p-6 sm:p-7 rounded-3xl space-y-6 border-brand-ember/20 shadow-2xl">
            ...
            <button
              ...
              className="w-full py-4 rounded-2xl bg-brand-ember hover:bg-red-700 text-white font-syne font-extrabold text-sm flex items-center justify-center gap-2 shadow-xl shadow-brand-ember/30 hover:brightness-105 transition"
            >
